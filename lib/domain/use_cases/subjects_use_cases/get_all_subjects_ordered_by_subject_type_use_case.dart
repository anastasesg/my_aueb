...
class GetAllSubjectsOrderedBySubjectTypeUseCase extends UseCase<List<SubjectEntity>, void> {
  final SubjectsRepository _subjectsRepository;
  GetAllSubjectsOrderedBySubjectTypeUseCase(this._subjectsRepository);

  @override
  Future<List<SubjectEntity>> call({void params}) {
    return _subjectsRepository.getAllSubjectsOrderedBySubjectType();
  }
}
