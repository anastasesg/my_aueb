...
class GetAllSubjectsOrderedByDepartmentUseCase extends UseCase<List<SubjectEntity>, void> {
  final SubjectsRepository _subjectsRepository;
  GetAllSubjectsOrderedByDepartmentUseCase(this._subjectsRepository);

  @override
  Future<List<SubjectEntity>> call({void params}) {
    return _subjectsRepository.getAllSubjectsOrderedByDepartment();
  }
}
