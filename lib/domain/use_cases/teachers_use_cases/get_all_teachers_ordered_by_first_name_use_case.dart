...
class GetAllTeachersOrderedByFirstNameUseCase extends UseCase<List<TeacherEntity>, void> {
  final TeachersRepository _teachersRepository;
  GetAllTeachersOrderedByFirstNameUseCase(this._teachersRepository);

  @override
  Future<List<TeacherEntity>> call({void params}) {
    return _teachersRepository.getAllTeachersOrderedByFirstName();
  }
}
