...
class GetAllTeachersOrderedByDepartmentUseCase extends UseCase<List<TeacherEntity>, void> {
  final TeachersRepository _teachersRepository;
  GetAllTeachersOrderedByDepartmentUseCase(this._teachersRepository);

  @override
  Future<List<TeacherEntity>> call({void params}) {
    return _teachersRepository.getAllTeachersOrderedByDepartment();
  }
}
